...
export default function ProductModal({ isOpen, onClose, product, onSave, categories }: ProductModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const productData = {
                name: formData.name,
                slug: generatedSlug, // Inserted slug to pass SQL NOT NULL constraint!
            ...
            alert('¡Producto guardado exitosamente!'); // Simple confirmation
            onSave();
            onClose();
        } catch (error: any) {
                                ...
                                <select 
                                    ...
                                    onChange={(e) => {
                                        if (e.target.value === 'NEW') {
                                            setFormData({...formData, newCategory: ' '}); // trigger text input
                                        } else {
