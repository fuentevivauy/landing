...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('fuente-barroca', 'Fuente Barroca', '🏰 La majestuosidad hecha fuente. Con su diseño barroco de tres niveles y un sonido de agua envolvente, esta pieza transformará tu jardín en un palacio real. Impresionante y eterna. 🌊✨', 23990, '$23.990', 'Fuentes', true, true, ARRAY['Motor profesional de 4500 L/h para cascada espectacular', 'Tres niveles con ornamentación barroca detallada', 'Ideal para jardines amplios y espacios comerciales', 'Sonido envolvente que transforma el ambiente']::TEXT[], '{"levels":3,"height":"1.75 m / 2.15 m","diameter_main":"96 cm","weight":"200 kg","motor":"4500 L/h (50W)","material":"Hormigón vibrado inyectado","installation":"Media a compleja"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/fuente-barroca_1775918802470.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/fuente-barroca_1775918802470.jpg']::TEXT[], 'Hola! Me interesa este producto: Fuente Barroca')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('fuente-buda-flor-loto-grande', 'Fuente Buda Flor de Loto Grande', '🧘‍♀️ Meditación en tu patio. La unión perfecta entre la figura de Buda y la pureza del loto. Un rincón para respirar y reconectar contigo mismo. 🕉️✨', 12990, '$12.990', 'Fuentes', true, false, ARRAY['Combinación de escultura y fuente', 'Tamaño ideal para patios medianos', 'Motor de bajo consumo', 'Acabado cemento natural']::TEXT[], '{"height":"75 cm","diameter_main":"77 cm","weight":"40 kg","motor":"550 L/h (10W con regulador de presión)","material":"Hormigón vibrado inyectado","color":"Cemento"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/fuente-buda-flor-loto-grande_1775918809186.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/fuente-buda-flor-loto-grande_1775918809186.jpg']::TEXT[], 'Hola! Me interesa este producto: Fuente Buda Flor de Loto Grande')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('fuente-kiara-chica', 'Fuente Kiara Chica', '💧 Encanto azul. Su acabado en piedra azul envejecida la hace única. Una joya compacta que aporta color y frescura a cualquier espacio. 💙', 8990, '$8.990', 'Fuentes', true, false, ARRAY['Diseño compacto y elegante', 'Acabado piedra azul único', 'Motor silencioso incluido', 'Perfecta para patios pequeños']::TEXT[], '{"height":"96 cm","diameter":"55 cm","diameter_main":"55 cm","weight":"60 kg","motor":"550 L/h (10W) con regulador de presión","material":"Hormigón vibrado inyectado","color":"Piedra azul envejecida"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/fuente-kiara-chica_1775918815362.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/fuente-kiara-chica_1775918815362.jpg']::TEXT[], 'Hola! Me interesa este producto: Fuente Kiara Chica')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('bebedero-aves-extra-grande', 'Bebedero de Aves Extra Grande', '🐦 Vida en tu jardín. Nuestro bebedero más grande se convertirá en el punto de encuentro favorito de las aves silvestres. ¡Un espectáculo natural en tu ventana! 🌳🦅', 8990, '$8.990', 'Bebederos', true, false, ARRAY['Tamaño extra grande para múltiples aves', 'Instalación básica y sencilla', 'Resistente a la intemperie', 'No requiere motor']::TEXT[], '{"height":"82 cm","diameter":"75 cm","diameter_main":"75 cm","weight":"45 kg","material":"Hormigón vibrado inyectado","installation":"Básica"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/bebedero-aves-extra-grande_1775918817844.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/bebedero-aves-extra-grande_1775918817844.jpg']::TEXT[], 'Hola! Me interesa este producto: Bebedero de Aves Extra Grande')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('bebedero-aves-labrado', 'Bebedero Aves Labrado', '🎨 Detalle artesanal. Cada pliegue labrado cuenta una historia. Un bebedero que combina funcionalidad con una estética clásica y refinada. 🏺🐦', 2900, '$2.900', 'Bebederos', true, false, ARRAY['Detalles labrados a mano', 'Precio accesible', 'Sin mantenimiento de motor', 'Diseño atemporal']::TEXT[], '{"height":"55 cm","diameter":"54 cm","diameter_main":"54 cm","weight":"25 kg","material":"Hormigón vibrado inyectado","installation":"Básica"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/bebedero-aves-labrado_1775918819549.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/bebedero-aves-labrado_1775918819549.jpg']::TEXT[], 'Hola! Me interesa este producto: Bebedero Aves Labrado')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('bebedero-aves-64-cm', 'Bebedero Aves (64 cm)', '🌿 El tamaño perfecto. Ni muy grande ni muy chico, ideal para cualquier jardín. Invita a la naturaleza a formar parte de tu hogar. 🦋', 2900, '$2.900', 'Bebederos', true, false, ARRAY['Altura ideal para jardines', 'Fácil de mantener', 'Atrae vida silvestre', 'Resistente al clima']::TEXT[], '{"height":"64 cm","diameter":"48 cm","diameter_main":"48 cm","weight":"25 kg","material":"Hormigón vibrado inyectado","installation":"Básica"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/bebedero-aves-64-cm_1775918820509.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/bebedero-aves-64-cm_1775918820509.jpg']::TEXT[], 'Hola! Me interesa este producto: Bebedero Aves (64 cm)')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('pavo-real-chico', 'Pavo Real Chico', '🦚 Elegancia real. Símbolo de inmortalidad y belleza, este pavo real con su acabado en pátina azul es una joya decorativa que no pasará desapercibida. 💙', 3590, '$3.590', 'Estatuas', true, false, ARRAY['Diseño elegante y distintivo', 'Acabado azul con pátina', 'Tamaño decorativo perfecto', 'Símbolo de belleza']::TEXT[], '{"dimensions":"0.47 m x 39 cm","weight":"28 kg","material":"Hormigón vibrado inyectado","color":"Azul con detalles y pátina"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/pavo-real-chico_1775918827105.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/pavo-real-chico_1775918827105.jpg']::TEXT[], 'Hola! Me interesa este producto: Pavo Real Chico')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('enano-jardin-carro', 'Enano de Jardín con Carro', '🍄 Magia en el jardín. Este simpático personaje trae alegría y color a tus plantas. Un guardián divertido para tus rincones verdes. 🌈', 2700, '$2.700', 'Estatuas', true, false, ARRAY['Diseño divertido y único', 'Ideal para jardines familiares', 'Variedad de colores disponibles', 'Perfecto para rincones especiales']::TEXT[], '{"dimensions":"0.44 m x 48 cm","weight":"20 kg","material":"Hormigón vibrado inyectado","color":"Variedad de colores"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/enano-jardin-carro_1775918828722.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/enano-jardin-carro_1775918828722.jpg']::TEXT[], 'Hola! Me interesa este producto: Enano de Jardín con Carro')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('buho-jardin', 'Búho de Jardín', '🦉 Sabiduría silenciosa. Con su mirada atenta y acabado patinado, este búho aporta un toque de misterio y elegancia natural a tu entorno. 🍂', 2250, '$2.250', 'Estatuas', true, false, ARRAY['Símbolo de sabiduría', 'Acabado patinado elegante', 'Tamaño decorativo ideal', 'Ligero y fácil de mover']::TEXT[], '{"dimensions":"42 cm x 20 cm","weight":"8 kg","material":"Hormigón vibrado inyectado","color":"Patinado"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/buho-jardin_1775918830397.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/buho-jardin_1775918830397.jpg']::TEXT[], 'Hola! Me interesa este producto: Búho de Jardín')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('tortuga-porta-maceta', 'Tortuga Porta Maceta', '🐢 Naturaleza sobre naturaleza. Esta adorable tortuga no solo decora, sino que acoge tus plantas favoritas. Un detalle lleno de vida y color. 🌸', 1990, '$1.990', 'Estatuas', true, false, ARRAY['Funcional y decorativo', 'Ideal para plantas pequeñas', 'Acabado colorido encantador', 'La más económica de la colección']::TEXT[], '{"dimensions":"22 cm x 35 cm","weight":"10 kg","material":"Hormigón vibrado inyectado","color":"Verde y marrón patinado"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/tortuga-porta-maceta_1775918832236.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/tortuga-porta-maceta_1775918832236.jpg']::TEXT[], 'Hola! Me interesa este producto: Tortuga Porta Maceta')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('juego-mesa-bancos-romano', 'Juego Mesa y Bancos Romano', '🏛️ Banquetes imperiales. Reúne a tu familia en un espacio de elegancia clásica. Este juego de mesa y bancos de hormigón está hecho para durar eternamente. 🍇🍷', 25800, '$25.800', 'Muebles y Accesorios', true, true, ARRAY['Set completo: mesa + 2 bancos', 'Estilo romano clásico', 'Hormigón vibrado de alta resistencia', 'Ideal para reuniones al aire libre']::TEXT[], '{"table_dim":"1.50 m x 75 cm","bench_dim":"42 cm x 1.50 m","material":"Hormigón vibrado inyectado","color":"Cemento natural"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/juego-mesa-bancos-romano_1775918833164.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/juego-mesa-bancos-romano_1775918833164.jpg']::TEXT[], 'Hola! Me interesa este producto: Juego Mesa y Bancos Romano')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('banco-madera-jardin-grande', 'Banco de Madera de Jardín Grande', '🌲 Descanso natural. La solidez del hormigón se une a la calidez de la madera. El lugar perfecto para sentarse a disfrutar de tu jardín con un buen libro. 📖☕', 9900, '$9.900', 'Muebles y Accesorios', true, false, ARRAY['Estructura inquebrantable de hormigón', 'Madera tratada resistente', 'Soporta hasta 290 kg', 'Diseño clásico elegante']::TEXT[], '{"height":"1.20 m","width":"1.50 m","dimensions":"50 cm profundidad","material":"Hormigón vibrado inyectado y madera tratada","color":"Cemento","maxLoad":"290 kg"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/banco-madera-jardin-grande_1775918833886.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/banco-madera-jardin-grande_1775918833886.jpg']::TEXT[], 'Hola! Me interesa este producto: Banco de Madera de Jardín Grande')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
...
INSERT INTO public.products (slug, name, description, price, price_formatted, category, in_stock, featured, benefits, specs, image_thumbnail, image_gallery, whatsapp_message)
VALUES ('farol-chino-grande', 'Farol Chino Grande', '🏮 Luz de Oriente. Dale a tu jardín un aire místico y sofisticado. Este imponente farol crea juegos de luz y sombra que transforman la noche. 🎋✨', 5990, '$5.990', 'Muebles y Accesorios', true, false, ARRAY['Estética oriental auténtica', 'Tamaño imponente', 'Ideal para jardines zen', 'Punto focal nocturno']::TEXT[], '{"dimensions":"1.30 m x 40 cm x 40 cm","weight":"40 kg","material":"Hormigón vibrado inyectado","installation":"Básica"}'::jsonb, 'https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/farol-chino-grande_1775918834779.jpg', ARRAY['https://ixzkuosmzqescxalkmbr.supabase.co/storage/v1/object/public/product-images/products/farol-chino-grande_1775918834779.jpg']::TEXT[], 'Hola! Me interesa este producto: Farol Chino Grande')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    description = EXCLUDED.description,
    price = EXCLUDED.price,
